 ...
 * Todo：请正确填写您的客户端ip
 */
#define ClientIpValue @"127.0.0.1"

/*
 * Todo: 请填写您的应用的appkey和appsecret
 */
#define oauthAppKey @"801255147"
#define oauthAppSecret @"875d58fb566cb9e9183830dde6515fbc"

/*
 * Todo：请正确填写您的应用网址，否则将导致授权失败
 */
#define redirect_uri @"http://easyfollow.com"
